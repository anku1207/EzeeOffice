...
public class ApiUrl {
    ...
    //previous url
    //http://dms.cbslgroup.in/json_api/testApi/

    // EzeeOffice demo url
    // url: https://demo.ezeeoffice.co.in/Api/

    //Ezeeoffice betatest url
    //url : http://144.48.78.35/Json_API/EzeeOffice/




   // public static final String BASE_URL ="https://demo.ezeeoffice.co.in/Api/";
    public static final String BASE_URL ="http://144.48.78.35/Json_API/EzeeOffice/";
   //public static final String BASE_URL ="https://demoenterprise.ezeeoffice.co.in/Api/";
    ...
    public static final String CHECK_CLIENT_MEMORY = BASE_URL+"checkClientMemory.php";

    //new Apis for ezeeoffice
    public static final String LOGIN_URL = BASE_URL+"index.php";
    public static final String DASHBOARD_URL = BASE_URL+"dashboard.php";
    public static final String APPOINTMENT = BASE_URL+"appointment.php";
    public static final String TODO = BASE_URL+"todo.php";
    public static final String RESET_PWD = BASE_URL+"forgotPwd.php";
    public static final String VIEWER_LOGS = BASE_URL+"Logs.php";
    public static final String FREQ_QUERY = BASE_URL+"FreqQuery.php";

    //Convert To pdf
    public static final String CONVERT_TO_PDF = BASE_URL+"convertToPdf.php";
